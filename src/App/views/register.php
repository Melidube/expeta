  ...
  <?php include $this->resolve('partials/_csrf.php'); ?>
    ...
    <label class="block">
      ...
      >
        ...
        <option value="Zimbabwe" <?php echo $oldFormData['country'] === 'Zimbabwe' ? 'selected' : ''; ?> >Zimbabwe</option>
        <option value="Botswana" <?php echo $oldFormData['country'] === 'Botswana' ? 'selected' : ''; ?> >Botswana</option>
